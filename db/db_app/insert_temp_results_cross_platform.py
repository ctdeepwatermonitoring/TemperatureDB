...
if system == "Windows":
    in_dir = Path("C:/Users/deepuser/testFTP/")
    cf_dir = Path("C:/Users/deepuser/cnf/user.cnf.txt")
else:
    in_dir = Path("/home/deepuser/testFTP/")
    cf_dir = Path("/home/deepuser/cnf/user.cnf.txt")
